namespace PlayersAndMonsters.Core
{
    ...
    public class ManagerController : IManagerController
    {
        ...
        public string AddPlayer(string type, string username)
        {
            ...
            string result = string.Format(ConstantMessages.SuccessfullyAddedPlayer, 
                player.GetType().Name, player.Username);
            return result;
        ...
        public string AddCard(string type, string name)
        {
            ...
            string result = string.Format(ConstantMessages.SuccessfullyAddedCard,
                type, card.Name);
            return result;
        ...
        public string AddPlayerCard(string username, string cardName)
        {
            ...
            var result = string.Format(ConstantMessages.SuccessfullyAddedPlayerWithCards,
        ...
        public string Fight(string attackUser, string enemyUser)
        {
            ...
            var result = string.Format(ConstantMessages.FightInfo,
